    ...
    <el-carousel :interval="5000" arrow="never" height="650px" ref="carousel">
      <el-carousel-item>
       ...
       <!-- <el-carousel-item v-for="(item,index) in leftContentData" :key="index">         
        <LeftContentItem :isFirst="isFirst" :isLast="isLast" :nextPic="nextPic" :prePic="prePic" 
        :title='item.title' :subTitle="item.subTitle" :rewards="item.rewards" :pics="item.pics"
        />
      </el-carousel-item>
      <el-carousel-item>
      ...
      <el-carousel-item>
          <RightContentItem :isFirst="isFirst" :isLast="isLast" :nextPic="nextPic" :prePic="prePic"/>
      </el-carousel-item> -->
    </el-carousel>
  </div>
</template>
...
export default {
  ...
  methods: {
    prePic() {
      console.log("pre...");
      this.index = (this.index - 1) % this.leftContentData.length;
    ...
    isLast() {      
      return this.index === this.leftContentData.length - 1;
    },
    isFirst() {    
      return this.index === 0;
    }
