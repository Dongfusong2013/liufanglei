<template>
  <div class="view column-box-center cover">
    <div class="bg-title-font title-margin-top">合作单位</div>
    <div class="sm-title-font content-margin-top">北京—杭州—厦门，营造中国与世界的沟通之所 建筑语言：功能流线，空间结构，形态外延，文化内涵</div>
    ...
    <div class="row-box-center box-right-offset" style="margin-top: 162px; margin-bottom: 79px;">
      <div class="item-right-margin column-box-center">
        ...
        <div class="sm-content-font">010 - 87213595</div>
      </div>
      ...
      <div class="item-right-margin column-box-center">
        ...
        <div class="sm-content-font">23429486@qq.com</div>
      </div>
      <div class="column-box-center">
        <div class="sm-pic-size sm-pic-bottom">
          <img src="/static/main/编组 3.png" alt height="100%" width="100%" />
        </div>
        <div class="sm-content-font">北京市西城区百万庄大街11号</div>
      </div>
    </div>

    <div
      class="sm-content-font"
      style="margin-bottom: 61px;"
    >Copyright@ 2008-2020 BlueFocus. All Rights Reserved 京ICP备19003641</div>
  </div>
</template>
